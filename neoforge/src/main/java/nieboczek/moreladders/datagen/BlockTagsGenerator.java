...
public final class BlockTagsGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(BlockTags.CLIMBABLE)
                ...
                .add(MLBlocks.CRIMSON_LADDER, MLBlocks.IRON_LADDER, MLBlocks.ACACIA_LADDER, MLBlocks.CHAIN_LADDER, MLBlocks.CHERRY_LADDER)
                .add(MLBlocks.BAMBOO_LADDER, MLBlocks.MANGROVE_LADDER, MLBlocks.GOLD_LADDER, MLBlocks.PALE_OAK_LADDER, MLBlocks.COPPER_LADDER)
                .add(MLBlocks.EXPOSED_COPPER_LADDER, MLBlocks.WEATHERED_COPPER_LADDER, MLBlocks.OXIDIZED_COPPER_LADDER, MLBlocks.WAXED_COPPER_LADDER)
                .add(MLBlocks.WAXED_EXPOSED_COPPER_LADDER, MLBlocks.WAXED_WEATHERED_COPPER_LADDER, MLBlocks.WAXED_OXIDIZED_COPPER_LADDER);
